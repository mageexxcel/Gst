...
define(
    ...
    function (ko, Component, quote, totals) {
        "use strict";
        var productionState = window.checkoutConfig.Excellence_Gst.production_state;
        var moduleStatus = window.checkoutConfig.Excellence_Gst.status;
        var shippingGstStatus = window.checkoutConfig.Excellence_Gst.shipping_status;
        ...
        return Component.extend({
            defaults: {
                ...
                template: 'Excellence_Gst/checkout/summary/tax'
            },

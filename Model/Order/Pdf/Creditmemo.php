 ...
 */
namespace Excellence\Gst\Model\Order\Pdf;
...
//        $lines[0][] = [
//            'text' => $this->string->split(__('HSN'), 12, true, true),
//            'feed' => 315,
//            'align' => 'right',
//        ];
    ...
    public function getPdf($creditmemos = [])
    {
        ...
        $this->_productionState = $this->_scopeConfig->getValue('gst/excellence/production_state', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);

        $this->_productionStatus = str_replace(' ', '', strtolower($this->_productionStatus));
        $this->_shippingGstStatus = $this->_scopeConfig->getValue(
            "gst/excellence/shipping_status",
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
        $this->_beforeGetPdf();
        ...
        foreach ($creditmemos as $creditmemo) {
            ...
            if($this->_moduleStatus){
                /* Add head */
                $this->insertOrderCustomCreditmemo(
                    $page,
                    $order,
            ...
            if($this->_moduleStatus){
                /* Add totals */
                $this->insertTotalsCustomCreditmemo($page, $creditmemo);
            }
            else{
                /* Add totals */
     ...
     */
    protected function insertTotalsCustomCreditmemo($page, $source)
    {
    ...
    protected function insertOrderCustomCreditmemo(&$page, $obj, $putOrderId = true)
    {

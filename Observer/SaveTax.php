 ...
 */
namespace Excellence\Gst\Observer;
...
class SaveTax implements \Magento\Framework\Event\ObserverInterface {
    ...
    public function execute(\Magento\Framework\Event\Observer $observer ) {
        ...
        if (count($orderIds)) {
            ...
            $productionState = $this->_scopeConfig->getValue('gst/excellence/production_state', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
